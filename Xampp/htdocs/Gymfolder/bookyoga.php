...
<?php
   ...
   $query ="SELECT `Sessioname`,`Price`,`Sessiondesc`,`Sessionduration`,`Sessiondate` FROM `sessions`  WHERE (`Sessiondate` > NOW()) AND (`SeriesID` ='1') ORDER BY `Sessiondate` DESC ";
