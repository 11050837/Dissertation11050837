...
<?php
   ...
   $query ="SELECT `Sessioname`,`Price`,`Sessiondesc`,`Sessionduration`,`Sessiondate` FROM `sessions`  WHERE (`Sessiondate` > NOW()) AND (`SeriesID` = '2') ORDER BY `Sessiondate` DESC ";
...
echo "<form action='bookcircuits.php' method='POST'>";
